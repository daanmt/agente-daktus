"""
Agent V2 Unified Pipeline - Single Entry Point

This is the ONLY pipeline. All analysis goes through here.
No legacy, no fallbacks, no dual-run.
"""
...
# Calculate project root: src/agent_v2/pipeline.py -> project root
...
def analyze(protocol_path: str, playbook_path: Optional[str] = None, model: Optional[str] = None) -> Dict:
    """
    Main analysis function - Agent V2 ONLY pipeline.
    
    This is the single entry point for all protocol analysis.
    No legacy code, no fallbacks, no conditions.
    ...
    """
    logger.info("=" * 60)
    logger.info("Agent V2 Pipeline - Starting Analysis")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("Agent V2 Pipeline - Analysis Complete")
    logger.info("=" * 60)
