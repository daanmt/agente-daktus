"""
Structured Logger for Agent V2
Provides consistent logging across all Agent V2 modules
"""
...
class StructuredLogger:
    """Structured logger for Agent V2 with JSON output"""
    
    def __init__(self, name: str = "agent_v2", log_dir: str = "logs"):
